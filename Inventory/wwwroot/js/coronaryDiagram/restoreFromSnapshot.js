    ...
    snapshot.cells.forEach(data => {
        ...
        if (ElementClass) {
            ...
            switch (data.type) {
                ...
                case 'custom.Region': cell = new joint.custom.Region(data); break;
                case 'custom.Worm': cell = new joint.custom.Worm(data); break;
                case 'custom.UpBottomStroke': cell = new joint.custom.UpBottomStroke(data); break;
                case 'custom.FormNote': cell = new joint.custom.FormNote(data); break;
