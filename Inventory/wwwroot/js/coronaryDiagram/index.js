import { getStroke } from '../../lib/perfect-freehand/dist/esm/index.mjs';
import {
    dia,
    shapes,
    g,
...
const Region = dia.Element.define(
    'custom.Region',
    {
...
const Worm = dia.Element.define('custom.Worm', {
...
const UpBottomStroke = dia.Element.define('custom.UpBottomStroke', {
...
const FormNote = dia.Element.define(
    'custom.FormNote',
    {
...
const FormNoteView = dia.ElementView.extend({
    render() {
...
const SvgElement = dia.Element.define('custom.SvgElement', {
...
// Application
// -----------
const custom = { Region, Worm, UpBottomStroke, FormNote, FormNoteView };
const joint = {
    dia,
    shapes,
    g,
...
const region = new joint.custom.Region({
    position: { x: 0, y: 0 },
    z: -1,
});
FormNote.prototype.defaultView = FormNoteView;
